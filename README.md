...
Once the `conda-forge` channel has been enabled, `ovh` can be installed with:

```
conda install ovh
```

It is possible to list all of the versions of `ovh` available on your platform with:
